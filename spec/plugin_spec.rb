  ...
  describe Plugin do
    ...
    context '#decrypt' do
      ...
      it 'decrypts fast' do
        Dir.chdir('test') do
          start_time = Time.now
          repeat.times { |i| plugin.send(:decrypt, crypt) }
          stop_time = Time.now
